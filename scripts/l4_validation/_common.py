...
from vision_model_serving.validation.reporting import (  # noqa: E402
...
FOCALNET_TRAINING_SHA256 = "67a7b0cd787a3aaba199cf1ff82ed2934c33ffe37544473379d7a837ab1637b4"
FOCALNET_INFERENCE_SHA256 = "a7fed981c7309d12c19532624e148b45087462c56568797cb62b60055bb62f04"
...
PREPROCESSED_ARRAY_SHA256 = "97fa0f80a696ce7f822c1681a8c3f7c072da9262b2bd91239c9f1637eaf68552"
DETECTOR_PREDICTION_SHA256 = "4cdd09d986702e8839acff8d7517a63f263ca2a01b0607d78d6b2086c886a9a5"
MMBCD_INPUT_TENSOR_SHA256 = "89cda9694e3696f63eb70706a6ae4cc2dd16e9be214f27ba6f106479eac90155"
MMBCD_PREDICTION_SHA256 = "43ec1c4593c0549510098ea082ea7092c7fd5631c95d8b912ecf31633185899b"
...
def default_paths() -> dict[str, Path]:
    ...
    return {
        ...
        "tokenizer_dir": (STUDIO_ROOT / "assets" / f"roberta-base-tokenizer-{ROBERTA_REVISION}"),
    }
...
def verify_sha256(path: Path, expected: str) -> str:
    ...
    if actual.lower() != expected.lower():
        raise RuntimeError(f"SHA-256 mismatch for {path}: expected {expected}, observed {actual}")
    return actual
